...
import "./IDDRankedAccess.sol";

contract DDRankedMatches is AccessControl {
    struct Match {
        address player1;
        address player2;
        address winner;
    ...
    // address public constant RANKED_ACCESS_ADDRESS = 0x8c98434b7CA12571568065ab2fbE2248fA0bA504;
    ...
    address public RANKED_ACCESS_ADDRESS;

constructor(address rankedAccessAddress) {
    RANKED_ACCESS_ADDRESS = rankedAccessAddress;
...
function _hasAccessKey(address player) private view returns (bool) {
    IDDRankedAccess rankedAccess = IDDRankedAccess(RANKED_ACCESS_ADDRESS);
