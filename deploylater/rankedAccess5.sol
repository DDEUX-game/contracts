...
* with contract optimization help from Jorropo from the IPFS Office Hours.
*/
...
contract RankedAccess5 is ERC721Base {
   ...
   */
   ...
   {
    // owner = msg.sender;
    // so that we can automatically forward the value sent in to the deployers wallet, which will have access to the rankedMatches.sol save function.
   }
